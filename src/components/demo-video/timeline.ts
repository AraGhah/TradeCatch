...
export const NARRATION: Record<DemoLocale, Record<SceneId, string>> = {
  en: {
    ...
    5: "Accept the job and the technician is alerted with the lead. Appointment confirmation is planned — this scene is illustrative.",
    6: "Quote follow-up on unanswered estimates is a planned module shown here as a walkthrough, not live product behavior yet.",
    7: "Illustrative reporting: recovered / booked / reactivated figures are demo data. A live client dashboard is not shipping yet.",
  ...
  fr: {
    ...
    5: "Acceptez le job — le technicien reçoit la fiche. La confirmation de rendez-vous est prévue; cette scène est illustrative.",
    6: "La relance de soumissions sans réponse est un module prévu, montré ici en walkthrough — pas encore le comportement produit live.",
    7: "Reporting illustratif : les chiffres récupéré / réservé / réactivé sont des données démo. Le tableau de bord client n'est pas encore livré.",
