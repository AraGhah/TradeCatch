        ...
        {rows.map((row) => (
          <div key={row.manual} className="grid grid-cols-2 divide-x divide-navy/10">
            <div className="flex items-start gap-2.5 px-5 py-4 sm:px-6">
              <AlertIcon className="mt-0.5 h-4 w-4 shrink-0 text-orange-dark" />
              <p className="text-sm leading-relaxed text-text/70">{row.manual}</p>
            </div>
            <div className="flex items-start gap-2.5 px-5 py-4 sm:px-6">
              <CheckIcon className="mt-0.5 h-4 w-4 shrink-0 text-green" />
              <p className="text-sm leading-relaxed text-navy">{row.system}</p>
            </div>
          </div>
        ))}
      </div>
